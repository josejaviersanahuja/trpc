...
CREATE TABLE `User` (
    ...
    `role` ENUM('USER', 'WRITER', 'ADMIN', 'SUPER_ADMIN') NOT NULL DEFAULT 'USER',
...
CREATE TABLE `Post` (
    ...
    `titleSpanish` VARCHAR(191) NOT NULL,
    `titleEnglish` VARCHAR(191) NOT NULL,
    `contentSpanish` VARCHAR(191) NULL,
...
CREATE TABLE `Like_Post` (
    ...
    UNIQUE INDEX `Like_Post_userId_postId_key`(`userId`, `postId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Like_Comment` (
    ...
    UNIQUE INDEX `Like_Comment_userId_commentId_key`(`userId`, `commentId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
